...
function IMSIPTV_CreateAccount(array $params) {
    ...
    try {
        ...
        switch ($billingcycle) {
            case"Free Account":
                $subscriptionlengthindays = $params['model']['product']['autoterminatedays'];
                $renewalinterval = $params['model']['product']['autoterminatedays'];
            ...
            case"Quarterly":
                $subscriptionlengthindays = 0;
                $subscriptionlengthinmonths = 3;
                $renewalinterval = 3;
                break;
            case"Semi-Annually":
                $subscriptionlengthindays = 0;
                $subscriptionlengthinmonths = 6;
                $renewalinterval = 6;
                break;
            case"Annually":
                $subscriptionlengthindays = 0;
            ...
            case"Biennially":
                $subscriptionlengthindays = 0;
                $subscriptionlengthinmonths = 24;
                $renewalinterval = 24;
                break;
            case"Triennially":
                $subscriptionlengthindays = 0;
                $subscriptionlengthinmonths = 36;
                $renewalinterval = 36;
        }

        $data['subscriptionlengthindays'] = $subscriptionlengthindays;
        $data['subscriptionlengthinmonths'] = $subscriptionlengthinmonths;
        $data['renewalinterval'] = $renewalinterval;
        $data['StartSubscriptionFromFirstLogin'] = $params['configoption6'];
        $data['sendMail'] = $params['configoption7'];
        $data['sendSMS'] = $params['configoption8'];
...
function IMSIPTV_ChangePackage(array $params)
{
    try {
        ...
        $data['subscriptionlengthinmonths'] = $subscriptionlengthinmonths;
        //$data['uuid'] = $params['customfields']['MacAddress'];
        $url = $baseurl . '/api/ChangeCustomerProduct/changeCustomerProductAsync?' . http_build_query($data);
        $resp = IMSIPTV_sendData($url, 'post');
        $jsonData = json_decode($resp, true);
        logModuleCall(
                'IMSIPTV', __FUNCTION__, $data, $resp
